  ...
  return (
    <section className="relative overflow-hidden bg-background py-24 sm:py-32" id="about">
      ...
      <div className="container relative mx-auto px-4">
        ...
        >
          <motion.div variants={imageVariants} className="group relative lg:w-5/12">
          ...
          <div className="space-y-10 lg:w-1/2">
            ...
            <motion.div variants={itemVariants} className="space-y-6 text-lg leading-relaxed text-muted-foreground antialiased">
              <p>{t("description1")}</p>
              <p>{t("description2")}</p>
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 gap-6 pt-4 sm:grid-cols-3">
              {stats.map((stat, idx) => (
