...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/"
  ...
  <ShortName>Ahmed Shoman</ShortName>
  <ShortName xml:lang="ar">أحمد شومان</ShortName>
  <Description>Search Ahmed Shoman Portfolio - Explore projects, blog posts, and more</Description>
  <Description xml:lang="ar">ابحث في معرض أعمال أحمد شومان - استكشف المشاريع والمقالات وأكثر</Description>
  ...
  <InputEncoding>UTF-8</InputEncoding>
  <Developer>Ahmed Shoman (ahmed@ahmedlotfy.site)</Developer>
  <Attribution>Copyright ${new Date().getFullYear()} Ahmed Shoman</Attribution>
  <SyndicationRight>open</SyndicationRight>
  <AdultContent>false</AdultContent>
  <Tags>portfolio developer web nextjs react typescript fullstack أحمد شومان مطور ويب</Tags>
