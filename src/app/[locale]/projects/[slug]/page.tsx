        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 pt-24 md:pt-32">
            ...
            <ImageViewer
                ...
                className={cn(
                    ...
                    isMobile ? "max-w-sm md:max-w-md aspect-[9/19] rounded-[2rem] md:rounded-[3rem]" : "max-w-5xl aspect-video rounded-2xl md:rounded-[2rem]"
                )}
            >
            ...
            <div className="max-w-4xl mx-auto space-y-8 md:space-y-12 mb-20 text-start md:text-center">
                 <div className="space-y-6">
                    ...
                    <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/70">
                        {title}
                    </h1>
                 </div>
