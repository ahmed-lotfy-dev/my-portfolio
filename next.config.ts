...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/:locale/_next/static/:path*", destination: "/_next/static/:path*" },
      { source: "/:locale/_next/image", destination: "/_next/image" },
      { source: "/:locale/images/:path*", destination: "/images/:path*" },
      { source: "/:locale/icons/:path*", destination: "/icons/:path*" },
      { source: "/:locale/cv/:path*", destination: "/cv/:path*" },
      { source: "/:locale/favicon.ico", destination: "/favicon.ico" },
      { source: "/:locale/Ahmed-Lotfy-CV.pdf", destination: "/Ahmed-Lotfy-CV.pdf" },
      { source: "/:locale/site.webmanifest", destination: "/site.webmanifest" },
      { source: "/:locale/og-image.png", destination: "/og-image.png" },
      { source: "/:locale/heroImg.svg", destination: "/heroImg.svg" },
